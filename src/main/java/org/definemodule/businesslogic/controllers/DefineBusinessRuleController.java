...
//    }
    ...
    public BusinessRuleType giveBusinessRuleTypeByName(String name) {
        return postgresServiceProvider.getBusinessRuleTypePostgresService().getBusinessRuleTypeByName(name);
    }
